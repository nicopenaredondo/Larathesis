...
return array(
    ...
    */
    ...
    'collections' => array(
        ...
        {
            $collection->directory('assets/stylesheets/css',function($collection){
            $collection->add('bootstrap.css');
            $collection->add('elusive-webfont.css');
           })->apply('UriRewriteFilter')->setArguments(public_path());
        },

        'public-js' => function($collection)
        {
            $collection->directory('assets/javascripts/js',function($collection){
